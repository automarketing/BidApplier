                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form action="<?php echo site_url('admin/subscriber/mobile'); ?>" name="subscriberInfoSearchForm" id="subscriberInfoSearchForm" method="POST" class="form-inline" role="form">
                                ...
                                <div class="modal-dialog modal-md" tabindex="-1" role="dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="border-bottom:#eeeeee 1px solid;">
                                            ...
                                            <h4 class="modal-title">Mobile Subscriber's Information</h4>
                                        </div>
                                ...
                                <div class="modal-dialog modal-lg" tabindex="-1" role="dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="border-bottom:#eeeeee 1px solid;">
                                            ...
                                            <h4 class="modal-title">Mobile Subscriber's Payment Information</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="container-fluid" style="padding-left:0px;padding-right:0px;">
                                                <div class="row">
