...
{			
	...
	public function loadCustomDB($groupName){
		$this->load->database($groupName, FALSE, TRUE);
	}
	...
	//=====================================================function parameter specifications begin===================================================
		...
		// $order_by =  order by (string)								Ex- 'id asc,name desc'  // also array parameter accepted as $data[]
