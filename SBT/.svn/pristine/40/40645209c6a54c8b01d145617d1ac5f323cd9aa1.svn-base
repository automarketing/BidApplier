...
function SvgCreatorLibrary(id)
{
    ...
    this.UpdateCircleDom = function (circle, x, y)
    {
    ...
    this.UpdateRectangleDom = function (rect, x, y, width, height)
    {
    ...
    this.UpdateLineDom = function (line, x1, y1, x2, y2)
    {
    ...
    this.AddPolygon = function ( pList ,  strokeColor, fillColor, strokeDash, strokeWidth, opacity, id, cssClass  )
    {
        ...
        shape.setAttributeNS(null, "points", pStr );
        shape.setAttributeNS(null, "fill", fillColor); 
    ...
    this.AddText = function (x, y, text, style, id)
    {
