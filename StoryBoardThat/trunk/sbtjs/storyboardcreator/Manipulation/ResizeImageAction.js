...
function ResizeImageAction()
{
    ...
    this.Public_ResizeShapes = function(e)
    {
        ...
        if (XScale == null || YScale == null || XScale < 0.1 || YScale < 0.1 )// protect against belowing size 10
            return;

        if( ( privateBoxArea.Width < 10 && XScale < 1 )  || ( privateBoxArea.Height < 10 && YScale < 1) )
            return;
        

        console.log( "ScaleSize" ,  XScale , YScale );
