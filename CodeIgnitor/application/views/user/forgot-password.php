...
<body class="fp-page">
        ...
        <div class="card">
            <div class="body">
                <form id="forgot_password" method="POST">
                    ...
                    <button class="btn btn-block btn-lg bg-orange waves-effect" type="submit">RESET MY PASSWORD</button>

                    <div class="row m-t-20 m-b--5 align-center">
                        <a href="/user/login/user_register">Sign In!</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script src="/includes/AdminBSB/js/pages/examples/forgot-password.js"></script>
</body>
