                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form action="<?php echo site_url('admin/channelvod/category'); ?>" name="categorySearchForm" id="categorySearchForm" method="POST" class="form-inline" role="form">
                                    ...
                                    <tr class="tableDataTR">
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary" name="categoryEditBtn_<?php echo $categoryData['uid']; ?>" id="categoryEditBtn_<?php echo $categoryData['uid']; ?>" data-uid="<?php echo $categoryData['uid']; ?>" title="Edit Category"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                          	<button type="button" class="btn btn-primary" name="categoryDeleteBtn_<?php echo $categoryData['uid']; ?>" id="categoryDeleteBtn_<?php echo $categoryData['uid']; ?>" data-uid="<?php echo $categoryData['uid']; ?>" title="Delete Category"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
